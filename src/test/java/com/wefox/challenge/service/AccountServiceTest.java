...
public class AccountServiceTest {
  ...
  public void prepareDataSet() {
    ...
    AddressVO addressVO = AddressVO.builder().id(address.getId()).address(address.getAddress())
  ...
  public void testFindByEmail() throws Exception {
    Optional<AccountVO> accountVO1 = this.accountService
        .findByEmail("aitor.gonzalez.martinez@gmail.com");
